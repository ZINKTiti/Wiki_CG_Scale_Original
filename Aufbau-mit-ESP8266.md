...
Die Anleitung zum laden der Firmware findet man hier:

ab V2.x: [Firmware V2.x auf ESP8266 laden](https://github.com/nightflyer88/CG_scale/wiki/Firmware-V2.x-auf-ESP8266-laden)

ältere Version V1.x: [Firmware V1.x auf ESP8266 laden](https://github.com/nightflyer88/CG_scale/wiki/Firmware-V1.x-auf-ESP8266-laden)
